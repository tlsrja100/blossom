...
<br />
	...
	<div class="form-group">
		<label class="join">회원 정보 변경</label>
	</div>
	<div class="form-group">
		<form action="/blossom/mypage" method="post" id="modifypage">
			<div class="form-group">
				<label for="email">이메일</label>
				<input type="text" class="form-control" id="email" name="email" readonly="readonly" value="${login.email}"/>
			...
			<div class="form-group text-center" style="margin-top:100px;">
				<button type="submit" class="joinbtn">정보수정</button>
			</div>
		</form>
	</div>
</body>
